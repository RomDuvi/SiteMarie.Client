...
import { PaypalConfig, Client } from '../../../models/paypalConfig.model';
...
export class PaypalComponent implements  OnChanges {
  ...
  ngOnChanges(changes:  SimpleChanges) {
    ...
    this.config.env = this.configService.config.paypalEnv;
    this.config.client = new Client(this.configService.config.paypalClient, this.configService.config.paypalClient);
    this.initOptions();
  }
